...
emission_transition <- function(timestep, sd){
  x_current <- vector(length=(timestep+1))
  x_current[1] <- 0 #just some number for indexing
  z_current <- vector(length=(timestep+1))
  z_current[1] <- runif(1,0,100) #intitial model
  ...
  return(list("obs"=x_current[-1], "states"=z_current[-1]))
}

obs_states <- emission_transition(timestep, sd=1)
x_obs <- obs_states$obs
z_states <- obs_states$states
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist(particles1[1,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1, t=1")
abline(v = z_states[1],col="red")
abline(v = exp_location[1],col="blue")
# legend("topleft",c("true position","expected, sd=1"),
#        col = c("red","blue"), lty = c(1, 1), lwd=c(2, 2))
hist(particles1[25,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1, t=25")
abline(v = z_states[25],col="red")
abline(v = exp_location[25],col="blue")

hist(particles1[75,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1, t=75")
abline(v = z_states[75],col="red")
abline(v = exp_location[75],col="blue")

hist(particles1[timestep,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1, t=100")
...
```{r}
#sd=5 in emission
obs_states2 <- emission_transition(timestep, sd=5)
x_obs2 <- obs_states2$obs
z_states2 <- obs_states2$states
particles2 <- particle_filter(x_obs2, num_particles, timestep, sd=5)
exp_location2 <- rowMeans(particles2)

#sd=50 in emission
obs_states3 <- emission_transition(timestep, sd = 50)
x_obs3 <- obs_states3$obs
z_states3 <- obs_states3$states
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist(particles2[1,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=5, t=1")
abline(v = z_states2[1],col="red")
abline(v = exp_location2[1],col="blue")
# legend("topleft",c("true position","expected, sd=1"),
#        col = c("red","blue"), lty = c(1, 1), lwd=c(2, 2))
hist(particles2[25,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=5, t=25")
abline(v = z_states2[25],col="red")
abline(v = exp_location2[25],col="blue")

hist(particles2[75,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=5, t=75")
abline(v = z_states2[75],col="red")
abline(v = exp_location2[75],col="blue")

hist(particles2[timestep,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=5, t=100")
abline(v = z_states2[timestep],col="red")
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist(particles3[1,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=50, t=1")
abline(v = z_states3[1],col="red")
abline(v = exp_location3[1],col="blue")
# legend("topleft",c("true position","expected, sd=1"),
#        col = c("red","blue"), lty = c(1, 1), lwd=c(2, 2))
hist(particles3[25,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=50, t=25")
abline(v = z_states3[25],col="red")
abline(v = exp_location3[25],col="blue")

hist(particles3[75,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=50, t=75", xlim=c(100,145)) #change limits
abline(v = z_states3[75],col="red")
abline(v = exp_location3[75],col="blue")

hist(particles3[timestep,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=50, t=100")
abline(v = z_states3[timestep],col="red")
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist(particles4[1,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1 no correction, t=1")
abline(v = z_states[1],col="red")
abline(v = exp_location4[1],col="blue")
# legend("topleft",c("true position","expected, sd=1"),
#        col = c("red","blue"), lty = c(1, 1), lwd=c(2, 2))
hist(particles4[25,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1 no correction, t=25")
abline(v = z_states[25],col="red")
abline(v = exp_location4[25],col="blue")

hist(particles4[75,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1 no correction, t=75", xlim = c(50,200)) #change limits
abline(v = z_states[75],col="red")
abline(v = exp_location4[75],col="blue")

hist(particles4[timestep,],freq = FALSE,col = "grey",xlab = "Particles",main="sd=1 no correction, t=100")
abline(v = z_states[timestep],col="red")
abline(v = exp_location4[timestep],col="blue")
```

```{r, echo=FALSE}
plot(x_obs, pch=19, main="sd=1, no correction", xlab="Time step", ylab="Position")
lines(z_states, col="red")
lines(exp_location, col="blue")

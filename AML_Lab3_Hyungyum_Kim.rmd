...
When the weight=1 for every particle which means there is no correction, results of 4 time steps get really worse. Some true locations and expected locations are missing in the histograms above. As the correction process decreases uncertatinty this result is understandable.
